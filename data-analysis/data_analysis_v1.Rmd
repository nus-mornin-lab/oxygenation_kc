...
save.image(file = "RData/data_analysis_v1_checkpoint1.RData")
```
...
load("RData/data_analysis_v1_checkpoint1.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/data_analysis_v1_checkpoint_vent2_3.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/data_analysis_v1_checkpoint_vent3.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image("RData/data_analysis_v1_checkpoint2.RData")
```
...
```{r gamfitMed}
pdf(file = "Figures/med_v1.pdf", width = plot_width,
    height = 3, pointsize = point_size, family = font)

par(mfcol = c(1,2), cex = 1)

gam_plotMed(gamfitMed_eICU, main = "eICU-CRD")

gam_plotMed(gamfitMed_MIMIC, main = "MIMIC")
...
```{r gamfitProp}
pdf(file = "Figures/prop_v1.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfcol = c(2,2), cex = 1)

summary(gamfitProp_eICU)
gam_plotProp(gamfitProp_eICU, main = "eICU-CRD")

summary(gamfitProp_below_eICU)
gam_plotProp(gamfitProp_below_eICU, main = "")
...
gam_plotProp(gamfitProp_MIMIC, main = "MIMIC")

summary(gamfitProp_below_MIMIC)
gam_plotProp(gamfitProp_below_MIMIC, main = "")
...
```{r include=FALSE, eval=FALSE}
save.image("RData/data_analysis_v1_checkpoint3.RData")
```
