...
save(patient, O2measurement, file = "RData/eICU_data_analysis_v7_checkpoint1.RData")
```
...
load("RData/eICU_data_analysis_v7_checkpoint1.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/eICU_data_analysis_v7_checkpoint_vent.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/eICU_data_analysis_v7_checkpoint_vent2.RData")
```

```{r include=FALSE, eval=TRUE}
load(file = "RData/eICU_data_analysis_v7_checkpoint_vent2.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/eICU_data_analysis_v7_checkpoint_vent2_2.RData")
```

```{r include=FALSE, eval=TRUE}
load(file = "RData/eICU_data_analysis_v7_checkpoint_vent2_2.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/eICU_data_analysis_v7_checkpoint_vent2_3.RData")
```

```{r include=FALSE, eval=TRUE}
load(file = "RData/eICU_data_analysis_v7_checkpoint_vent2_3.RData")
```
...
### We do not subset by `high_vent_proportion` since this is not recorded for those on supplementary oxygen.
...
cat("\nCases with supplementary oxygen selected:", sum(patient_subset$oxygen_therapy_type == 1) )
...
```{r include=FALSE, eval=FALSE}
save.image(file = "RData/eICU_data_analysis_v7_checkpoint_vent3.RData")
```
...
```{r include=FALSE, eval=FALSE}
save.image("RData/eICU_data_analysis_v7_checkpoint2.RData")
```
...
load("RData/eICU_data_analysis_v7_checkpoint2.RData")
```
...
gam_plotProp <- function(gamfitProp, main = "Effect of treatment regime", yRange = c(0, .3)){
  print(paste("Number of cases:", summary(gamfitProp)$n))
  
xRange = c(0, max(patient_subset$prop, na.rm= TRUE))

xlab <- expression("Proportion of time with an SpO"[2]*" within 94% to 97%")
ylab <- "Probability of ICU mortality" 
...
```{r gamfitMed}
pdf(file = "Figures/med_v7.pdf", width = plot_width,
...
gam_plotMed(gamfitMed_supp, main = "Supplementary oxygen")
...
```{r gamfitProp}
pdf(file = "Figures/prop_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
gam_plotProp(gamfitProp_supp, main = "Supplementary oxygen")
...
computeCI <- function(gam_fit, data) {
  ...
  sep = ""
    ...
    tmp <- or_gam(data = data, model = gam_fit, pred = "prop", values = c(.8, .4))
...
```{r}
computeCI(gamfitMed_supp, data = patient_subset[patient_subset$oxygen_therapy_type == 1,])
computeCI(gamfitMed_vent, data = patient_subset[patient_subset$oxygen_therapy_type >= 2 & !is.na(patient_subset$high_vent_proportion),])

computeCI(gamfitProp_supp, data = patient_subset[patient_subset$oxygen_therapy_type == 1,])
computeCI(gamfitProp_vent, data = patient_subset[patient_subset$oxygen_therapy_type >= 2 & !is.na(patient_subset$high_vent_proportion),])
```
...
```{r}
data_tmp <- patient_subset[patient_subset$oxygen_therapy_type == 1,]
tmp <- gam(mortality_in_ICU ~ s(median), data = data_tmp, family = binomial)
computeCI(tmp, data = data_tmp)

data_tmp <- patient_subset[patient_subset$oxygen_therapy_type >= 2 & !is.na(patient_subset$high_vent_proportion),]
tmp <- gam(mortality_in_ICU ~ s(median), data = data_tmp, family = binomial)
computeCI(tmp, data = data_tmp)


data_tmp <- patient_subset[patient_subset$oxygen_therapy_type == 1,]
tmp <- gam(mortality_in_ICU ~ s(prop), data = data_tmp, family = binomial)
computeCI(tmp, data = data_tmp)
...
```{r}
pdf(file = "Figures/all_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
#gamfitMed <- gamm(mortality_in_ICU ~ s(median)+gender+s(age)+s(bmi)+s(sofatotal), data = patient_subset, family = binomial, random = list(hospital_id = ~ 1), contol=list(niterEM=10))$gam # Fails to converge due to lack of effect of hospital_id. Therefore, we fit it without the random effect.
gamfitMed <- gam(mortality_in_ICU ~ s(median)+gender+s(age)+s(bmi)+s(sofatotal), data = patient_subset, family = binomial)
gam_plotMed(gamfitMed, main = "Median oxygen saturation")
...
gam_plotProp(gamfitProp, main = "Adherence to oxygen goal")
...
```{r}
pdf(file = "Figures/med_APACHE_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
gam_plotMed(gamfitMed_type, main = "Supplementary oxygen")
...
pdf(file = "Figures/prop_APACHE_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
gam_plotProp(gamfitProp_type, main = "Supplementary oxygen")
...
```{r}
pdf(file = "Figures/med_vent_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_vent_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/med_ICU_type_v7.pdf", width = plot_width,
...
pdf(file = "Figures/prop_ICU_type_v7.pdf", width = plot_width,
    height = 6 * n_type/2, pointsize = point_size, family = font)
par(mfrow = c(n_type,1), cex = 1)
...
```{r sepsis}
pdf(file = "Figures/med_sepsis_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_sepsis_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/med_AF_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_AF_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/med_CKD_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_CKD_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/med_CHF_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_CHF_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
```{r COPD}
pdf(file = "Figures/med_COPD_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_COPD_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/med_chronic_liver_disease_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_chronic_liver_disease_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
```{r stroke}
pdf(file = "Figures/med_stroke_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_stroke_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
```{r cancer}
pdf(file = "Figures/med_cancer_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_cancer_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
```{r diabetes}
pdf(file = "Figures/med_diabetes_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_diabetes_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
```{r hypertension}
pdf(file = "Figures/med_hypertension_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
...
pdf(file = "Figures/prop_hypertension_v7.pdf", width = plot_width,
    height = 6, pointsize = point_size, family = font)
par(mfrow = c(2,1), cex = 1)
